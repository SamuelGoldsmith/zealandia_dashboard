...
function TextBox({
  ...
  ...props
    ...
    if (type == null) {
        return (
            <div className={cn(`w-9/10 bg-primary-tp text-center p-5 h-auto m-3 rounded-sm sm:flex-wrap`, className)} {...props}>
        ...
        return (
            <div
                className={cn(`w-9/10 bg-deep-brown text-center flex-row p-6 h-auto m-3 rounded-sm sm:flex-wrap`, className)} {...props}>
        ...
        return (
            <div
                className={cn(` w-auto inline-flex bg-deep-brown text-center flex-row p-6 h-auto m-3 rounded-sm sm:flex-wrap`, className)} {...props}>
                {secondaryText && <span className={cn("text-m text-kowahi-gold font-bold mr-3")}>{secondaryText}</span>}
                {text && <span className={cn("text-m text-primary font-bold")}>{text}</span>}
                {children}
            </div>
        ...
        return (
            <div
                className={cn(`w-fit text-left rounded-sm h-auto m-3 p-6 sm:flex-wrap`, className)} {...props}>
